...
const Departments = () => {
  ...
  const handleAddSubmit = async (e) => {
    e.preventDefault()
    try {
      const newDep = await adminApi.post("/createDepartment", formData)
      console.log(newDep)
      togglePopup()
  ...
  const handleDelete = async (id) => {
    try {
      const result = await adminApi.delete(`/deleteDepartment/${id}`)
      console.log(result)
  ...
  return (
    <div className="departments-container">
      ...
      <div className="inner-container">
                ...
                <tr key={department._id} className="table-row">
                  {editDepId === department._id ? (
                    <>
                      ...
                      <td className="table-row-data r-border">
                        <input
                          className="table-inputs inputs em-pas"
                          type="text"
                          name="name"
        ...
        <Popup
          trigger={
            <button className="dep-btn add-btn">+ Add Department</button>
          }
          modal
          nested
        >
          {(close) => (
            ...
            >
              ...
              <div className="add-btn-div">
                <button
                  className="dep-inputs dep-btn dep-one"
                  onClick={() => close()}
                >
                  Cancel
                </button>
                <input
                  ...
                  name="submit"
                  value="Submit"
                  className="dep-inputs dep-btn dep-two"
                />
              </div>
            </form>
          )}
